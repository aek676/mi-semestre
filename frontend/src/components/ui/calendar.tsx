...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      classNames={{
        root: cn("w-full max-w-[900px]", defaultClassNames.root),
        months: cn(
          "flex gap-4 flex-col md:flex-row relative",
          defaultClassNames.months
        ),
        month: cn("flex flex-col w-full gap-4 pt-10", defaultClassNames.month),
        nav: cn(
          "flex items-center gap-1 w-full relative justify-between",
